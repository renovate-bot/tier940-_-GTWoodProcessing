...
public interface IGTWPModule {

    /**
     * What other modules this module depends on.
     * <p>
     * e.g. <code>new ResourceLocation("gtexpert", "foo_module")</code> represents a dependency on the module
     * "foo_module" in the container "gtexpert"
     */
    @NotNull
